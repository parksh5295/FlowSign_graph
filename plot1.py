...
def main():
    ...
    ax_f1.set_xticklabels(datasets, fontsize=76, rotation=0, ha='center')
    ...
    ax_acc.set_xticklabels(datasets, fontsize=76, rotation=0, ha='center')
    ...
    fig.legend(handles, labels, 
               ...
               frameon=True,
               fontsize=82,
               bbox_to_anchor=(0.5, 1.04),  # Moved legend up
