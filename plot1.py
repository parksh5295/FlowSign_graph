...
def main():
    ...
    ax_f1.set_title("F1 Score", fontsize=60)
    ax_f1.set_xticks(list(x))
    ax_f1.set_xticklabels(datasets, fontsize=56, rotation=90, ha='center')
    ax_f1.set_ylabel("F1 Score (%)", fontsize=58)
    ax_f1.set_ylim(0, 100)
    ax_f1.tick_params(axis='y', labelsize=54)
    ...
    ax_acc.set_title("Accuracy", fontsize=60)
    ax_acc.set_xticks(list(x))
    ax_acc.set_xticklabels(datasets, fontsize=56, rotation=90, ha='center')
    ax_acc.set_ylabel("Accuracy (%)", fontsize=58)
    ax_acc.set_ylim(0, 100)
    ax_acc.tick_params(axis='y', labelsize=54)
