...
def main():
    ...
    if needs_break:
        ...
        ax.plot(x_data, y_data1, 'k-', linewidth=20, clip_on=False, zorder=15)  # linewidth=7 -> 10으로 증가
        ax.plot(x_data, y_data2, 'k-', linewidth=20, clip_on=False, zorder=15)  # linewidth=7 -> 10으로 증가
